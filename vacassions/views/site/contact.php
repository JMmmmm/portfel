...
<div class="site-contact">
    ...
    <?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
        ...
        <div class="alert alert-success">
            Благодарим Вас за обращение. Мы ответим вам как можно скорее.
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form']); ?>
                    ...
                    <?= $form->field($model, 'email')->label('Ваш почтовый ящик') ?>

                    <?= $form->field($model, 'subject')->label('Тема') ?>

                    <?= $form->field($model, 'body')->textarea(['rows' => 6])->label('Сообщение') ?>

                    <?= $form->field($model, 'verifyCode')->label('Пожалуйста подтвердите что вы не робот')->widget(Captcha::className(), [
